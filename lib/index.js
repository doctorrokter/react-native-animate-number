...
function AnimateNumber({value, timing, interval, steps, countBy, onFinish, formatter, onProgress, ...rest}) {
  ...
  function prepareToAnimate(startFrom, endWith) {
    startFrom.current = startFrom;
    endWith.current = endWith;
    dirty.current = true;
  }
